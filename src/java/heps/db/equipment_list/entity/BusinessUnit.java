...
@NamedQueries({
    ...
    , @NamedQuery(name = "BusinessUnit.findById", query = "SELECT b FROM BusinessUnit b WHERE b.id = :id")
    , @NamedQuery(name = "BusinessUnit.findByName", query = "SELECT b FROM BusinessUnit b WHERE b.name = :name")})
public class BusinessUnit implements Serializable {
    ...
    public String toString() {
        return "heps.db.equipment_list.entity.BusinessUnit[ id=" + id + " ]";
    }
